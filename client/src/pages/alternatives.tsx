...
export default function AlternativesPage() {
  ...
  const onSubmit = (data: any) => {
    ...
    if (editingId !== null) {
      ...
      toast({ title: "Berhasil", description: "Warga baru berhasil ditambahkan" });
    }
  ...
  const handleDelete = (id: number) => {
    if (confirm("Hapus data warga ini beserta nilai penilaiannya?")) {
      ...
      toast({ title: "Dihapus", description: "Data berhasil dihapus", variant: "destructive" });
    }
  };
    ...
    <div className="space-y-8">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-secondary/50 hover:bg-secondary/50">
                  ...
                  <TableHead className="min-w-[250px]">Informasi Warga</TableHead>
                  {criteria.map(c => (
                    <TableHead key={c.id} className="whitespace-nowrap text-center min-w-[120px]">
                      {c.name}
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{editingId ? "Edit Data Warga" : "Input Warga Baru"}</DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Jl. Contoh No. 123, RT/RW..." className="resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Contoh: Lansia, Disabilitas, Janda..." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">Pastikan nilai sesuai satuan kriteria</span>
                </div>
